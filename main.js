...
{ p: "¿En qué año cayó el Imperio Romano de Occidente?", r: "476 d.C." },
 { p: "¿Qué muro dividía Berlín durante la Guerra Fría?", r: "El Muro de Berlín" },
{ p: "¿Quién fue el líder nazi durante la Segunda Guerra Mundial?", r: "Adolf Hitler" },
{ p: "¿Qué país lanzó la primera bomba atómica?", r: "Estados Unidos" },
{ p: "¿En qué año llegó el hombre a la Luna?", r: "1969" },
{ p: "¿Cuál fue la civilización precolombina que habitó el sur de México y Centroamérica?", r: "Los mayas" },
{ p: "¿Qué guerra se libró entre el Norte y el Sur de Estados Unidos?", r: "La Guerra de Secesión" },
{ p: "¿Qué emperador romano fue asesinado en los idus de marzo?", r: "Julio César" },
{ p: "¿Cuál fue el tratado que puso fin a la Primera Guerra Mundial?", r: "Tratado de Versalles" },
{ p: "¿Qué reina inglesa es conocida por su largo reinado en el siglo XIX?", r: "La reina Victoria" },
{ p: "¿Qué país fue invadido por Alemania para iniciar la Segunda Guerra Mundial?", r: "Polonia" },
{ p: "¿Quién fue el libertador de cinco países sudamericanos?", r: "Simón Bolívar" },
{ p: "¿En qué año se firmó la independencia de Estados Unidos?", r: "1776" },
{ p: "¿Qué evento histórico ocurrió el 14 de julio de 1789 en Francia?", r: "La toma de la Bastilla" },
{ p: "¿Qué civilización antigua usaba jeroglíficos?", r: "La egipcia" },
{ p: "¿Quién fue el dictador español desde 1939 hasta 1975?", r: "Francisco Franco" },
{ p: "¿Qué revolución ocurrió en Rusia en 1917?", r: "La Revolución Rusa" },
{ p: "¿Qué país fue gobernado por Benito Mussolini?", r: "Italia" },
{ p: "¿Qué tratado creó la Liga de las Naciones?", r: "El Tratado de Versalles" },
{ p: "¿Qué nave comandaba Cristóbal Colón en su primer viaje?", r: "La Santa María" },
{ p: "¿Quién fue el primer emperador de China?", r: "Qin Shi Huang" },
{ p: "¿Qué ciudad fue destruida por una erupción del Vesubio en el año 79 d.C.?", r: "Pompeya" },
{ p: "¿Qué imperio construyó una extensa red de caminos en Sudamérica?", r: "El Imperio Inca" },
{ p: "¿Quién fue el presidente de Estados Unidos durante la Guerra Civil?", r: "Abraham Lincoln" },
{ p: "¿Qué conflicto enfrentó a Estados Unidos y la Unión Soviética sin enfrentamiento directo?", r: "La Guerra Fría" },
{ p: "¿Qué filósofo fue maestro de Alejandro Magno?", r: "Aristóteles" },
{ p: "¿Quién fue el último zar de Rusia?", r: "Nicolás II" },
{ p: "¿Qué país usó por primera vez tanques en una guerra?", r: "Reino Unido" },
{ p: "¿Qué civilización construyó Machu Picchu?", r: "Los incas" },
{ p: "¿Quién pintó el mural 'El Guernica' como protesta contra la guerra?", r: "Pablo Picasso" },
{ p: "¿Qué revolución transformó la producción industrial en el siglo XVIII?", r: "La Revolución Industrial" },
{ p: "¿Qué general francés se convirtió en emperador?", r: "Napoleón Bonaparte" },
{ p: "¿En qué año cayó el Muro de Berlín?", r: "1989" },
{ p: "¿Qué isla del Caribe fue colonizada por esclavos rebeldes liderados por Toussaint Louverture?", r: "Haití" },
{ p: "¿Cuál fue la primera civilización conocida en la historia?", r: "Los sumerios" },
{ p: "¿Qué conflicto enfrentó a Estados Unidos con Vietnam?", r: "La Guerra de Vietnam" },
{ p: "¿Quién fue la reina de Francia ejecutada durante la Revolución Francesa?", r: "María Antonieta" },
{ p: "¿Qué gran imperio tuvo su capital en Constantinopla?", r: "El Imperio Bizantino" },
{ p: "¿En qué año comenzó la Primera Guerra Mundial?", r: "1914" },
{ p: "¿Qué país fue conocido como la URSS?", r: "Unión Soviética" },
{ p: "¿Qué gran descubrimiento científico realizó Isaac Newton?", r: "La ley de la gravedad" },
{ p: "¿Qué país sufrió el Holocausto?", r: "Alemania" },
{ p: "¿Quién fue el líder de la independencia de la India?", r: "Mahatma Gandhi" },
{ p: "¿Qué civilización construyó el Partenón en Atenas?", r: "Los griegos" },
{ p: "¿Qué documento firmaron los ingleses en 1215 que limitaba el poder del rey?", r: "La Carta Magna" },
  ],
...
{ p: "¿Qué gas es esencial para la respiración humana?", r: "Oxígeno" },
{ p: "¿Cómo se llama el proceso por el cual las plantas producen su alimento?", r: "Fotosíntesis" },
{ p: "¿Cuál es la fórmula química del agua?", r: "H2O" },
{ p: "¿Qué órgano bombea la sangre en el cuerpo humano?", r: "El corazón" },
{ p: "¿Qué tipo de energía proviene del sol?", r: "Energía solar" },
{ p: "¿Qué científico propuso la teoría de la relatividad?", r: "Albert Einstein" },
{ p: "¿Cuántos planetas hay en el sistema solar?", r: "8" },
{ p: "¿Qué animal es el más grande del mundo?", r: "La ballena azul" },
{ p: "¿Qué parte del cuerpo humano contiene el encéfalo?", r: "La cabeza" },
{ p: "¿Cuál es el metal más liviano?", r: "El litio" },
{ p: "¿Cómo se llama el satélite natural de la Tierra?", r: "La Luna" },
{ p: "¿Qué tipo de animal es una rana?", r: "Un anfibio" },
{ p: "¿Qué célula transporta oxígeno en la sangre?", r: "El glóbulo rojo" },
{ p: "¿Qué planeta es conocido como el planeta rojo?", r: "Marte" },
{ p: "¿Qué unidad se usa para medir la intensidad de una corriente eléctrica?", r: "Amperio" },
{ p: "¿Cuál es el estado de la materia del vapor de agua?", r: "Gaseoso" },
{ p: "¿Cómo se llama el estudio de los seres vivos?", r: "Biología" },
{ p: "¿Cuál es el hueso más largo del cuerpo humano?", r: "El fémur" },
{ p: "¿Qué elemento químico tiene el símbolo 'O'?", r: "Oxígeno" },
{ p: "¿Qué instrumento se usa para ver objetos muy pequeños?", r: "Microscopio" },
{ p: "¿Qué energía se genera a partir del movimiento del agua?", r: "Energía hidráulica" },
{ p: "¿Qué planeta tiene un sistema de anillos?", r: "Saturno" },
{ p: "¿Qué animales ponen huevos?", r: "Ovíparos" },
{ p: "¿Qué nombre recibe el cambio de estado de líquido a gas?", r: "Evaporación" },
{ p: "¿Cómo se llama el proceso de división celular?", r: "Mitosis" },
{ p: "¿Qué parte del cuerpo humano controla todas las funciones del cuerpo?", r: "El cerebro" },
{ p: "¿Cuál es el órgano responsable de filtrar la sangre?", r: "El riñón" },
{ p: "¿Qué se mide en grados Celsius?", r: "La temperatura" },
{ p: "¿Qué gas utilizan las plantas para hacer la fotosíntesis?", r: "Dióxido de carbono" },
{ p: "¿Qué parte de la célula contiene el material genético?", r: "El núcleo" },
{ p: "¿Cómo se llama el animal que cambia de color?", r: "Camaleón" },
{ p: "¿Qué se forma cuando la luz se descompone en el agua?", r: "Un arcoíris" },
{ p: "¿Qué tipo de animal es un tiburón?", r: "Un pez" },
{ p: "¿Qué nombre recibe el estudio del universo?", r: "Astronomía" },
{ p: "¿Qué planeta está más cerca del Sol?", r: "Mercurio" },
{ p: "¿Qué tejido conecta los músculos con los huesos?", r: "Tendones" },
{ p: "¿Qué órgano nos permite respirar?", r: "Los pulmones" },
{ p: "¿Qué tipo de energía se obtiene del viento?", r: "Energía eólica" },
{ p: "¿Qué es un eclipse?", r: "El ocultamiento de un cuerpo celeste por otro" },
{ p: "¿Qué órgano produce la insulina?", r: "El páncreas" },
{ p: "¿Cuál es el componente principal del sol?", r: "Hidrógeno" },
{ p: "¿Qué aparato mide la presión atmosférica?", r: "Barómetro" },
{ p: "¿Qué científico descubrió la penicilina?", r: "Alexander Fleming" },
{ p: "¿Qué nombre recibe la fuerza que atrae los objetos hacia la Tierra?", r: "Gravedad" },
{ p: "¿Qué planeta tiene un día más largo que su año?", r: "Venus" },
{ p: "¿Qué mineral es necesario para tener huesos fuertes?", r: "Calcio" },
{ p: "¿Qué nombre recibe el paso de sólido a líquido?", r: "Fusión" },
{ p: "¿Qué tipo de energía se libera en una explosión nuclear?", r: "Energía nuclear" },
{ p: "¿Qué parte de la flor produce el polen?", r: "Estambre" },
